...
public class MadLibRandom
{
	public static void main(String[] args)
	{
		...
		String[] colors = { "red", "orange", "yellow", "blue", "purple", "teal",
		...
		int adv1   = 0 + (int)(Math.random()* adverbs.length       ); // adverbs
		...
		System.out.printf("\"Don't be such a(n) %s! We're going in. I think it looks "+newad+"\n", noun2 );
